...
# =============================================================================
# Regime classifier location — override per-machine with an env var.
# Falls back to finding it next to the HYDRAGRID folder.

REGIME_CLASSIFIER_DIR = Path(
    os.environ.get(
        "REGIME_CLASSIFIER_DIR",
        Path(__file__).resolve().parent.parent.parent / "HYDRA_regime_classifier"
    )
)
REGIME_MODELS_DIR = REGIME_CLASSIFIER_DIR / "reports"
